...
"""
encoder_handler.map = (
    ((KC.MIDI_CC(0, 0), KC.MIDI_CC(0, 1), KC.MIDI_CC(0, 2)), (KC.MIDI_CC(1, bkMidiIncrement(1)), KC.MIDI_CC(1, bkMidiDecrement(1)), KC.N0), (KC.MIDI_CC(2, bkMidiIncrement(2)), KC.MIDI_CC(2,bkMidiDecrement(2)), KC.VOLD)),
)
